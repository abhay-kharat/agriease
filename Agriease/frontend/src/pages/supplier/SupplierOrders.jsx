...
export default function SupplierOrders() {
  ...
  return (
    <motion.div className="secondary-page market-v2 supplier-orders-v2" initial="hidden" animate="show" variants={staggerContainer}>
      <BackButton />
      <motion.div className="page-hero page-hero--supplier-orders page-hero--market" variants={fadeUp}>
      ...
      <motion.div className="supplier-orders-v2__filters" variants={fadeUp}>
      ...
      <motion.div className="supplier-orders-v2__list" variants={staggerContainer}>
        {filteredOrders.length === 0 && (
          <motion.div className="order-card" style={{ textAlign: "center", padding: "40px" }} variants={fadeUp}>
        ...
        {filteredOrders.map((order) => (
          <motion.div key={order.id} className="order-card supplier-orders-v2__card" style={{ display: "block" }} variants={fadeUp}>
            <div>
